...
SODIUM_EXPORT
int crypto_sign(unsigned char *sm, uint64_t *smlen_p,
                const unsigned char *m, uint64_t mlen,
                const unsigned char *sk);

SODIUM_EXPORT
int crypto_sign_open(unsigned char *m, uint64_t *mlen_p,
                     const unsigned char *sm, uint64_t smlen,
                     const unsigned char *pk);

SODIUM_EXPORT
int crypto_sign_detached(unsigned char *sig, uint64_t *siglen_p,
                         const unsigned char *m, uint64_t mlen,
                         const unsigned char *sk);
